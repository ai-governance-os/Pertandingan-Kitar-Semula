...
function save(state) {
  ...
  if (window.CloudSync?.enabled && !window.CloudSync.applyingRemote) {
...
const PET_SPECIES = [
  ...
  { id: "lingui",     zh: "獬豸",   en: "Xiezhi",         aura: "#5ADCAA", stages: ["🥚", "🐣", "🐐", "🦌", "🦁", "⚖️"] },
  ...
  { id: "xuanwu",     zh: "鲲鹏",   en: "Kunpeng",        aura: "#6FA8CC", stages: ["🥚", "🐣", "🐟", "🐋", "🦅", "🌌"] },
