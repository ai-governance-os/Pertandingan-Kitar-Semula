...
- **月初只清零可兑换奖卡余额**：神兽从 2026 年 9 月起按净奖卡成长，之前月份不计；之后月初不重置，兑换奖品不减成长；扣卡会影响成长阶段
- **进化 10 阶段**：🥚 蛋 → 破壳 → 幼兽 → 守护兽 → 战将兽 → 传奇 → 灵域 → 星耀 → 圣兽 → 神话（门槛 **0 / 20 / 50 / 100 / 150 / 250 / 400 / 600 / 750 / 1000** 历来净奖卡）。
- **体型差明显**（蛋 0.5 ×，神话 3.2 ×）—— 投影在电视上一眼就分得出成长
- **饥饿看「多久没有新星星」**：0-2 天饱 / 3-6 天有点饿 / 7-13 天饿 / 14 天以上很饿
- **饿超过 14 天 → 外表显得没精神**，但不退阶；只有扣卡且跨过门槛才会退阶
...
- 乐园使用轻量电影感素材，19 只神兽会在各自领地内前后左右自由巡游；手机版会自动排成单屏全景，不需要拖动寻找；
...
4. 学生用**本轮换奖期间**累计的 ⭐ 在 🎁 奖品兑换

### 🔁 学生奖卡由 ADMIN 结算
- 🎁 奖品页显示的 ⭐ 是**可兑换余额**，跨月保留，不在每月 1 号自动清零。
- 换奖结束后，ADMIN 在「管理面板 → 学生奖卡结算」点「结算本轮可兑换余额」，确认后开启新一轮可兑换余额累计。
- 结算不会删除发卡和兑换历史，也不会让神兽退化；老师每月发卡额度仍于 1 号重置。
